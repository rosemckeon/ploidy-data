...
all_counts <- readRDS("benefits/uneven_matching/data/_counts_1.rds")
...
null %>% ggplot(
  ...
  labs(
    caption = "\nNow gametes of uneven ploidy level are incompatible.\nThere is still no disturbance."
  )

# export plot as file
ggsave(
  paste0("triploid-sterility_ON-1.pdf"),
  path = "costs/uneven_matching_prob/plots", device = "pdf",
  width = 11.69, height = 8.27, units = "in",
  dpi = "retina",
  title = "Diploid Pollen Swamping of Polyploid Ovules"
)
